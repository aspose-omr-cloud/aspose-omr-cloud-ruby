...
module AsposeOmrCloud
  ...
  class OmrResponseContent
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ResponseFiles')
        if (value = attributes[:'ResponseFiles']).is_a?(Array)
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          response_files == o.response_files &&
          info == o.info
    end
    ...
    def hash
      [template_id, execution_time, response_files, info].hash
    end
